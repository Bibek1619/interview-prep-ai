      ...
      <div className="w-full min-h-full bg-[#FFFCEF] ">
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <header className="flex justify-between items-center mb-16">
            ...
            <button
              className="bg-linear-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:text-white border border-white  transition-colors cursor-pointer"
...
{" "}
            ...
            <div className="w-full md:w-1/2">
              ...
              <button
                className="bg-black text-sm font-semibold text-white px-7 py-2 rounded-full border border-yellow-100 hover:bg-yellow-100 hover:text-black hover:border-yellow-300 transition-colors cursor-pointer"
                onClick={handleCTA}
              >
                Get Started
              </button>
        ...
        <div className="w-full min-h-full bg-[#FFFCEF] mt-10">
          <div className="container mx-auto px-4 pt-10 pb-20">
            <section className="mt-5">
              <h2 className="text-2xl font-extrabold mb-12 text-center">
